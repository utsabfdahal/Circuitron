...
<p align="center">
  <img src="../circuitron_final_report/src/images/figures/block_diagram.png" alt="System Block Diagram" width="85%">
</p>
...
<p align="center">
  <img src="../circuitron_final_report/src/images/figures/flowchart.png" alt="Pipeline Flowchart" width="70%">
</p>
<p align="center"><em>Detailed flowchart of the ML pipeline from raw image input to CircuitJS1 output.</em></p>
...
<p align="center">
  <img src="../circuitron_final_report/src/images/figures/retrained_yolov7_result1.png" alt="YOLOv7 Detection Result" width="80%">
</p>
<p align="center"><em>YOLOv7 detection result showing bounding boxes and class labels on a hand-drawn circuit.</em></p>
...
| | Custom OCR | TrOCR |
|---|---|---|
| <img src="../circuitron_final_report/src/images/figures/custom_ocr_result1.png" alt="Custom OCR" width="400"> | <img src="../circuitron_final_report/src/images/figures/trocr_result1.png" alt="TrOCR" width="400"> |

<p align="center"><em>Side-by-side comparison: Custom CRNN (left) vs. fine-tuned TrOCR (right) on the same circuit image.</em></p>
...
| Otsu Thresholding | Skeleton with Endpoints | Adjacency Graph |
|---|---|---|
| <img src="../circuitron_final_report/src/images/figures/otsu_thresholding.png" alt="Binary Threshold" width="280"> | <img src="../circuitron_final_report/src/images/figures/skeleton_with_endpoints.png" alt="Skeleton Endpoints" width="280"> | <img src="../circuitron_final_report/src/images/figures/adjacency_graph.png" alt="Adjacency Graph" width="280"> |

<p align="center"><em>Wire detection stages: binary thresholding → skeletonization with endpoints → final adjacency graph.</em></p>
...
<p align="center"><em>Combined overlay showing YOLOv7 detections (green boxes), TrOCR values (blue text), and line detection connections (red lines) on the original image.</em></p>
...
<p align="center">
  <img src="../circuitron_final_report/src/images/figures/frontend_screenshot.png" alt="Frontend Screenshot" width="90%">
</p>
<p align="center"><em>Full-screen capture of the CIRCUITRON frontend with a sample circuit and AI Q&A interface.</em></p>
...
<p align="center">
  <img src="../circuitron_final_report/src/images/figures/frontend_circuit.png" alt="Digital Circuit Editor" width="90%">
</p>
<p align="center"><em>The auto-generated digital circuit in CircuitJS1 (color inverted), ready for interactive simulation.</em></p>
